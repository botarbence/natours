        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://localhost:3000/api/v2/users/login",
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: "http://localhost:3000/api/v2/users/logout"
            });
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYm90YXJiZW5jZSIsImEiOiJja29zYzhldm8wMDNjMnZvYWpsNm9uc3lxIn0.NR6TncOpEUOcVNBxCxhiuQ";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "http://localhost:3000/api/v2/users/updatemypassword" : "http://localhost:3000/api/v2/users/updateme";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
...
var stripe = Stripe("pk_test_51ItBDxD50Et7nKzYP9lFUfur5VsqL3t66pPHr8fsvnF9zapaUESjofNNUYwTPAm8UzciQdWqBqBBrrpFJ28bJzMZ00ddXpdwBz");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://localhost:3000/api/v2/bookings/checkout-session/".concat(tourId));
