...
exports.forgotPassport = catchAsync(async (req, res, next) => {
...
exports.resetPassport = catchAsync(async (req, res, next) => {
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  if (!(await user.verifyPassword(String(req.body.passwordCurrent)))) {
